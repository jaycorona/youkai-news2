...
<div id="respond" class="section">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
		...
		<p><?php echo __('Logged in as', 'Avada'); ?> <a href="<?php echo get_option('siteurl'); ?>/admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php echo __('Log out of this account', 'Avada'); ?>"><?php echo __('Log out &raquo;', 'Avada'); ?></a></p>
